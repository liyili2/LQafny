...
Inductive memb := CtxM (r: rmemb) (phi: contexts) | ALock (r: subprocess) (t: memb) | ActM (p: memb) (c: shareC) (Q: memb).
...
Definition fresh (c: nat) := c. (*TODO; may not be needed*)
